...
class NotesEndToEndTest  {
    ...
    fun saveNewNotes_orderByTitleDescending() {
        for(i in 1..3) {
            // Click on FAB to get to add note screen
            composeRule.onNodeWithContentDescription("Add Note", ignoreCase = true).performClick()
            ...
            composeRule
                ...
                .performTextInput(i.toString())
            // Save the new
            composeRule.onNodeWithContentDescription("Save Note", ignoreCase = true).performClick()
        }
